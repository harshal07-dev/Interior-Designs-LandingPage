...
const About = () => {
  return (
    <section className='max-w-7xl mx-auto border-b-1 mt-20' id='about'>
        ...
        <div className="flex flex-col items-center lg:space-x-8 mx-4 mb-20">
            ...
            lg:text-left max-w-5xl mx-auto mt-8">
                AT Vastuspace, we believe in transforming houses into dream homes.
                With a passion for design and a commitment to quality, our team of
                skilled proffessionals has been dedicated to delivering exceptional
                renovation services for over a decade. We specialize in creating 
                beautiful, functional spaces that reflect ou clients unique tastes
                and lifestyles. From modern kitchens and luxurious bathrooms to serene 
                outdoor living areas and cozy home offices, we bring our expertize to 
                every product, ensuring each renovation is tailored to meet your
                specific needs and desires. Our mission is to enhance the beauty and 
                functionality of your home, making it a place where you can truly thrive. 
            </p>
        </div>
